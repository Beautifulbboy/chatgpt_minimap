...
这是一个专为增强 ChatGPT 聊天体验而设计的浏览器扩展程序。它在页面右侧添加了一个类似 **VS Code Minimap** 的交互式导航条，帮助用户在长对话中快速定位、预览和跳转。

### 🌟 核心功能

* **可视化对话流**：在右侧展示整个对话的缩略图，蓝色块代表用户提问，绿色块代表 ChatGPT 回答。
...
5.  **开始使用**：刷新 [ChatGPT](https://chatgpt.com/) 页面即可看到右侧的 Minimap。
