...
<p align="center">
  <a href="https://github.com/Beautifulbboy/chatgpt-minimap.git">
...
An interactive browser extension designed to enhance the ChatGPT chat experience. It adds a navigation bar similar to the **VS Code Minimap** on the right side of the page, helping users quickly locate, preview, and jump through long conversations.

### 🌟 Key Features

* **Visual Conversation Flow**: Displays a thumbnail of the entire conversation on the right, with blue blocks for user queries and green blocks for ChatGPT responses.
...
5.  **Start Using**: Refresh [ChatGPT](https://chatgpt.com/) to see the Minimap.
